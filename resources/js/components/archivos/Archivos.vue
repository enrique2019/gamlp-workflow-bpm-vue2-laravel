                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row justify-content-left">
                            <div class="col-md-6">
                                <label>Código</label>
                                <input v-model="registro.nodo_codigo" class="form-control" placeholder="Codigo"
                                    disabled>
                            </div>
                            <div class="col-md-6">
                                <label>Descripción</label>
                                <input v-model="registro.nodo_descripcion" class="form-control"
                                    placeholder="Descripcion" disabled>
                            </div>
                            <div class="col-md-6">
                                <label>Nodo Padre</label>
                                <select v-model="registro.nodo_padre_id" class="form-control" placeholder="Padre" disabled>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row justify-content-left">
                            ...
                            <div class="col-md-6">
                                <label>Nodo Padre</label>
                                <select v-model="registro.nodo_padre_id" class="form-control" placeholder="Padre">
                                    <option value="-1">-- Seleccione Nodos --</option>
                                    <option v-for="s in nodosPadres" v-bind:value="s.nodo_id">
                                        {{ s.nodo_descripcion}} - {{ s.nodo_codigo}}
                                    </option>
    ...
    export default {
        ...
        methods: {
            ...
            insertarRegistro(e) {
                this.errores = [];
                /*
                if (!this.registro.trb_data.nodo_codigo) {
                    this.errores.push('Falta CI');
                }
                if (!this.registro.trb_data.nodo_descripcion || !this.registro.trb_data.trb_materno) {
