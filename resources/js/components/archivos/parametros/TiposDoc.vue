        ...
        <table class="table table-hover table-striped table-responsive" id="divTable">
          ...
          <tbody>
            <tr v-for="(r, index) in registros">
              <td width="3%" scope="row">{{ r.tdoc_id }}</td>
              ...
              <td>
                <span v-if="r.tdoc_estado === 'A'" class="badge badge-success">ACTIVO</span>
                <span v-else-if="r.tdoc_estado !== 'A'" class="badge badge-warning">{{ r.tdoc_estado }}</span>
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row justify-content-left">
              <div class="col-md-6">
                <label>Codigo</label>
                <input v-model="registro.tdoc_codigo" class="form-control" placeholder="Codigo" disabled />
              </div>
              <div class="col-md-6">
                <label>Descripcion</label>
                <input v-model="registro.tdoc_descripcion" class="form-control" placeholder="Descripcion" disabled />
              </div>
              <!--
              <div class="col-md-12">
                <label>Icono</label>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="row justify-content-left">
              <div class="col-md-12">
                <label>Codigo</label>
                <input v-model="registro.tdoc_codigo" class="form-control" placeholder="Codigo" />
              </div>
              <div class="col-md-12">
                <label>Descripcion</label>
                <input v-model="registro.tdoc_descripcion" class="form-control" placeholder="Descripcion" />
              </div>
              <!--
              <div class="col-md-12">
                <label>Icono</label>
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" @click="insertarRegistro($event)" data-dismiss="modal">
              Guardar
            </button>
          </div>
        </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" @click="actualizarRegistro($event)" data-dismiss="modal">
              Guardar
            </button>
          </div>
        </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-danger" @click="eliminarRegistro($event)" data-dismiss="modal">
              Si, eliminar
            </button>
          </div>
        </div>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        plural: "Tipos Documentales",
        singular: "Tipo Documental",
        seleccionado: "",
        errores: [],
        registro: {},
        registros: [],
    ...
    methods: {
      listarRegistros() {
        ...
        axios.get(url).then((response) => {
          ...
          console.log("Tipos Documentales: ", this.registros);
        });
      },
      ...
      insertarRegistro(e) {
        this.errores = [];
        /*
                  if (!this.registro.trb_data.tdoc_codigo) {
                      this.errores.push('Falta CI');
                  }
                  if (!this.registro.trb_data.tdoc_descripcion || !this.registro.trb_data.trb_materno) {
      ...
      actualizarRegistro(e) {
        ...
        if (this.errores.length === 0) {
          ...
          //gRegistro.tdoc_usr_id = 1;
          let that = this;
          let url = "api/tiposDoc/" + gRegistro.tdoc_id;
          axios
            .put(url, gRegistro)
            .then(function (response) {
              that.output = response.data;
