                ...
                <table class="table table-hover table-striped table-responsive" id="divTable">
                    ...
                    <tbody>
                        <tr v-for="(r, index) in registros">
                            <td width="3%" scope="row">{{ r.tfrm_id }}</td>
                            ...
                            <td>
                                <span v-if="r.tfrm_estado === 'A'" class="badge badge-success">ACTIVO</span>
                                <span v-else-if="r.tfrm_estado !== 'A'" class="badge badge-warning">{{
                                    r.tfrm_estado}}</span>
                            </td>
                        </tr>
                    </tbody>
                    ...
                    <div class="modal-body">
                        <div class="row justify-content-left">
                            <div class="col-md-12">
                                ...
                                <input v-model="registro.tfrm_descripcion" class="form-control"
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                plural: 'Tipos de Formularios',
                singular: 'Tipo de Formulario',
                seleccionado: '',
                errores: [],
                registro: {},
                registros: [],
        ...
        methods: {
            listarRegistros() {
                let url = "api/tformularios";
                axios.get(url).then(response => {
                    this.registros = response.data.data; //twice data
                    console.log("Tipos de Formularios: ", this.registros);
                });
            },
            ...
            insertarRegistro(e) {
                this.errores = [];
                /*
                if (!this.registro.trb_data.tact_codigo) {
                    this.errores.push('Falta CI');
                }
                if (!this.registro.trb_data.tfrm_descripcion || !this.registro.trb_data.trb_materno) {
            ...
            actualizarRegistro(e) {
                ...
                */
                if (this.errores.length === 0) {
                    ...
                    //gRegistro.tfrm_usr_id = 1;
                    let that = this;
                    let url = "api/tformularios/" + gRegistro.tfrm_id;
